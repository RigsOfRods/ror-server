...
#endif  // 0 // OGRE_COMPILER == OGRE_COMPILER_MSVC && OGRE_COMP_VER == 1300
...
#   define IS_NATIVE_WCHAR_T      1
# else
#   define IS_NATIVE_WCHAR_T      0
# endif
...
public:
	...
	typedef MY_INT32 unicode_char;

	//! a single UTF-16 code point
	typedef MY_UINT16 code_point;
